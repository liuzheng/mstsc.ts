...
export class Mstsc {
  ...
  UnicodeToCode = {
    'Firefox': {
      'fr': this.UnicodeToCodeFirefox_FR,
      'en': this.UnicodeToCode_EN
    },

    'Chrome': {
      'fr': this.UnicodeToCodeChrome_FR,
      'en': this.UnicodeToCode_EN
    }
  };
  ...
  private static browser() {
    ...
    if (userAgent.indexOf('Opera') > -1 || userAgent.indexOf('OPR') > -1) {
      ...
      return 'Chrome';
    } else if (userAgent.indexOf('rv:11.0) like Gecko') > -1) {
      return 'IE>=11';
    } else {
      return 'Unkonwn';
    }
   ...
   */
  scancode(e) {
    let locale = Mstsc.locale();
    locale = (['fr', 'en'].indexOf(locale) > 0 && locale) || 'en';
    return this.KeyMap[e.code || this.UnicodeToCode[Mstsc.browser() || 'Firefox'][locale][e.keyCode]];
  }
}
